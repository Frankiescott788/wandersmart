          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex-shrink-0">
              <a href="#" title="" className="flex">
                <img
                  ...
                  src="https://your-logo-url.com/logo.svg" // Replace with your travel app logo
            ...
            <div className="hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
              ...
              <a
                href="#"
                title=""
                className="inline-flex items-center justify-center px-5 py-2.5 text-base font-semibold transition-all duration-200 rounded-full bg-blue-500 text-white hover:bg-blue-600 focus:bg-blue-600"
                role="button"
              >
                Get Started
              </a>
          ...
          <div className="relative flex items-center justify-center w-full lg:order-2 lg:w-7/12">
            <div className="absolute bottom-0 right-0 hidden lg:block">
              <img
                ...
                src="https://your-image-url.com/curved-lines.png" // Add a relevant image for a travel app
                alt=""
              />
            </div>
            ...
            <div className="relative px-4 pt-24 pb-16 text-center sm:px-6 md:px-24 2xl:px-32 lg:py-24 lg:text-left">
              ...
              <p className="mt-8 text-xl text-black">
                We make travel planning easy! Discover the best destinations, guides, and travel packages.
              </p>
                    ...
                    <div className="flex-1 w-full min-w-0">
                      <div className="relative text-gray-400 focus-within:text-gray-600">
                        ...
                        <input
                          ...
                          name="email"
                          id="email"
                          placeholder="Enter email to get travel updates"
              ...
              <p className="mt-5 text-base text-black">
                Get exclusive offers and travel recommendations.
              </p>
            </div>
            ...
            <div className="absolute right-0 z-10 -bottom-16 lg:top-24 lg:-left-20">
              <img
                ...
                src="https://your-image-url.com/circular-text.png" // Replace with an appropriate image
                alt=""
              />
            </div>
          </div>
          ...
          <div className="relative w-full overflow-hidden lg:order-1 h-96 lg:h-auto lg:w-5/12">
            <div className="absolute inset-0">
              <img
                ...
                src="https://your-image-url.com/travel-image.jpg" // Replace with a travel-related image
            ...
            <div className="absolute bottom-0 left-0">
              <div className="p-4 sm:p-6 lg:p-8">
                <div className="flex items-center">
                  ...
                  <h2 className="font-bold text-white text-7xl ml-2.5">1,200+</h2>
                </div>
                <p className="max-w-xs mt-1.5 text-xl text-white">
                  Travelers have planned their dream vacations with us.
                </p>
              </div>
            </div>
          </div>
